...
const (
	ImageStyleHalfBlock ImageStyle = iota
	ImageStyleBraille
	ImageStyleCharacters
	ImageStyleBlockElementsAccurate
	ImageStyleBlockElementsFast
	ImageStyleFullBlock
)
...
var BayerMatrix4x4 = [4][4]float32{
	{0.0, 0.5, 0.125, 0.625},
...
var BayerMatrix8x8 = [8][8]float32{
