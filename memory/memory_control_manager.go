...
/*
GetAllEntries is a method which retrieves all control entries from a layer. In addition, the following should be noted:
...
/*
IsExists is a method which checks if a control entry exists in the memory manager. In addition, the following should be noted:
