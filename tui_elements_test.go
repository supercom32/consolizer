...
func TestDrawFrame(test *testing.T) {
	...
	Color(4, 6)
	FillLayer(layerAlias1, "a1a2a3a4a5")
	DrawFrame(layerAlias1, styleEntry, false, 2, 2, 10, 10, false)
	DrawFrame(layerAlias1, styleEntry, true, 15, 2, 10, 10, false)
	UpdateDisplay()
	layerEntry := commonResource.screenLayer
	obtainedValue := layerEntry.GetBasicAnsiStringAsBase64()
...
func TestDrawBorder(test *testing.T) {
	...
	Color(4, 6)
	FillLayer(layerAlias1, "a1a2a3a4a5")
	DrawBorder(layerAlias1, styleEntry, 2, 2, 10, 10, false)
	UpdateDisplay()
	layerEntry := commonResource.screenLayer
	obtainedValue := layerEntry.GetBasicAnsiStringAsBase64()
...
func TestDrawWindow(test *testing.T) {
	...
	Layer(layerAlias4)
	Color(14, 15)
	DrawWindow(layerAlias4, styleEntry, 0, 0, 10, 10, false)
	UpdateDisplay()
	layerEntry := commonResource.screenLayer
	obtainedValue := layerEntry.GetBasicAnsiStringAsBase64()
...
func TestDrawLines(test *testing.T) {
	...
	Color(4, 13)
	FillLayer(layerAlias1, "a1a2a3a4a5")
	DrawBorder(layerAlias1, styleEntry, 10, 4, 10, 10, false)
